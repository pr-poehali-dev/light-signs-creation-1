...
const SERVICES = [
  ...
  { icon: "Building2", title: "Световые фасады", desc: "Полное архитектурное освещение фасада. Превращаем здание в узнаваемый бренд города." },
];
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <button onClick={() => scrollTo("home")} className="flex items-center gap-2">
            ...
            <span className="font-['Oswald'] text-xl font-bold tracking-widest uppercase text-white">
              Light<span className="text-[#f5c842]">Sign</span>
            </span>
          </button>
      ...
      <footer className="py-10 border-t border-white/[0.05]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-white/15 font-['Montserrat']">
            © 2024 LightSign. Производство световой рекламы
          </p>
